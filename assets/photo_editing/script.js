...
$.fancybox.defaults.afterShow = function(instance, current) {
    ...
    return `
      <div class='imagereveal-modal-center'>
        <div class='container imagereveal-modal-container' style="position:relative;width:${width}px;height:${height}px;border:2px solid white;">
          <div class='img background-img' style='position:absolute;top:0;left:0;width:100%;height:100%;background-image:url(${imgUrl});background-size:${width}px 100%;background-position:left top;'></div>
          <div class='img foreground-img' style='position:absolute;top:0;left:0;width:50%;height:100%;background-image:url(${foregroundImage});background-size:${width}px 100%;background-position:left top;'></div>
  ...
  setTimeout(function() {
    ...
    $slider.on("focus", function(){
      ...
      // Solo permitir clics en el slider, ignorar clics fuera
      current.$content.off('mousedown.imagereveal').on('mousedown.imagereveal', function(e) {
