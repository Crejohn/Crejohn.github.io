...
$.fancybox.defaults.afterShow = function(instance, current) {
  ...
  function getRevealHtml(width, height) {
    ...
    <div class='slider-button' style="pointer-events:none;position:absolute;width:60px;height:30px;border-top-right-radius: 5px;border-top-left-radius: 5px;border-bottom-right-radius: 5px;border-bottom-left-radius: 5px;;background-color:white;left:50%;top:calc(50% - 18px);display:flex;justify-content:center;align-items:center;transform:translateX(-50%);"></div>
        </div>
      </div>
    `;
  }
  ...
  setTimeout(function() {
    ...
    setupSlider($slider, $foreground, $button);
