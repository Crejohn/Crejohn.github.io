    ...
    document.querySelectorAll('.item').forEach(item => {
        item.addEventListener('transitionend', (e) => {
            if (e.propertyName === 'flex-basis' && item.classList.contains('expanded')) {
                ...
                if (item.classList.contains('clicked')) {
                    // Ocultar el dropholder SOLO cuando realmente se activa el iframe
                    ...
                    if (!item.querySelector('.gallery-content')) {
                        ...
                        // Cargar la gallery usando el destino declarado por la tarjeta
        ...
        item.addEventListener('click', (e) => {
            if (!item.classList.contains('expanded')) {
                // Solo manejar click basados en estados expandidos/clickeados
                return;
            }
            ...
            if (item.classList.contains('clicked')) {
                ...
                // marcar como clicked e iniciar brillo hacia 1 mientras ocurre la expansión
