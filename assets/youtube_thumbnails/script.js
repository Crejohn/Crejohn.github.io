...
function initMenu() {
  // Evitar duplicidad de handlers de iconos (script de /assets/menu también los añade)
  // El script del menú principal ya controla abrir/cerrar y resaltar iconos.
  $(".icon-container").off('click').off('hover');

  // Manejar clic en items del menú, y solo prevenir si hay data-frame.
