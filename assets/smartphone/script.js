$(function(){
  ...
  const globalState = {
    apps: [
      ...
      {
        nombre: 'Fotos',
        icono: 'app_icons/photos.png',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'Cámara',
        icono: 'app_icons/camera.png',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'FaceTime',
        icono: 'app_icons/facetime.png',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'Clima',
        icono: 'app_icons/weather.png',
        type: 'app',
        dinamico: false
      },
      {
      ...
      {
        nombre: 'Musica',
        icono: 'app_icons/music.png',
        type: 'app',
        dinamico: false
      },
      {
        nombre: 'App Store',
        icono: 'app_icons/appstore.png',
        type: 'app',
        dinamico: false,
...
function actualizarBateria() {
  // Seleccionar todos los indicadores de batería relevantes (statusBar, lockScreen, lockScreen2)
  const $baterias = $('.mainScreen .statusBar .rightSide .bateria, .mainScreen .lockScreen .bateria, .mainScreen .lockScreen2 .bateria');

  $baterias.each(function() {
    const $bateria = $(this);
    // Eliminar todas las clases de nivel y color
    ...
    } else if (globalState.bateriaNivel > 20) {
  ...
  $(".menu li").click(function(e){
    ...
    if (frameId) {
      ...
      switch(frameId) {
        ...
        case 'logo-frame': url = '../branding/index.html'; break;
        ...
        case 'aboutme-frame': url = '../about/index.html'; break;
        case 'contact-frame': url = '../contact/contact_form/index.html'; break;
      }
